...
/**
 * Fetch autoalarm:* tags for the specified log group ARN.
 *
 * Behavior:
 * - Calls ListTagsForResource on the CloudWatch Logs client for the ARN.
 * - Iterates through the returned tags.
 * - Filters down to keys that start with "autoalarm:".
 * - Normalizes undefined values to empty strings.
 *
 * @param arn Full ARN of the log group resource.
 * @returns   Plain object of autoalarm:* tags and their string values.
 */
